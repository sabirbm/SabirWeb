        ...
        <div className="project__container">
          <div className="project__content">
            <h3 className="project__title">
              The Rapidu Ifrastructure Framwork
            </h3>
            <div className="project__box">
              <div className="project__rows">
                <span className="project__discription">
                  <ul>
                    <li>
                      Type designers love a good pangram. Pangrams, of course,
                      are sentences that contain each letter of the sentences
                      that contain each letter of the
                    </li>
                    <li>
                      sentences that contain each letter of the alphabet at
                      least once, of
                    </li>
              ...
              <div className="project__rows">
                ...
                <span className="project__discription">
                  <ul>
                    <li>
                      Type designers love a good pangram. Pangrams, of course,
                      are sentences that contain each letter of the
                    </li>
                    <li>
                      sentences that contain each letter of the alphabet at
                      least once, of
